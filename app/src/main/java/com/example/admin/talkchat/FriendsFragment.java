    ...
    public void onStart() {
       ...
       FirebaseRecyclerAdapter<Friends,FriendsViewHolder> friendsRecyclerViewAdapter = new FirebaseRecyclerAdapter<Friends, FriendsViewHolder>(
           ...
           protected void populateViewHolder(final FriendsViewHolder friendsviewHolder, final Friends friends, int i) {
               ...
               final String list_usre_id = getRef(i).getKey();

               mUsersDatabase.child(list_usre_id).addValueEventListener(new ValueEventListener() {
                   @Override
                   public void onDataChange(DataSnapshot dataSnapshot) {
                       ...
                       friendsviewHolder.mView.setOnClickListener(new View.OnClickListener() {
                           ...
                           public void onClick(View view) {
                               ...
                               builder.setTitle("Выбрать вариант");
                               builder.setItems(options, new DialogInterface.OnClickListener() {
                                   ...
                                   public void onClick(DialogInterface dialogInterface, int i) {
                                       ...
                                       if(i == 0){
                                           ...
                                           profileIntent.putExtra("user_id", list_usre_id);
                                       ...
                                       if(i == 1){
                                           ...
                                           chatIntent.putExtra("user_id", list_usre_id);
